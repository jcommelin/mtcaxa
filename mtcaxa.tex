...
by $\Isom((\Delta_1,\mu_1),(\Delta_2,\mu_2))^{\Gal(\bar Q/Q)}$.

Observe that there is a natural map
$\Isom((\Delta_1,\mu_1),(\Delta_2,\mu_2))^{\Gal(\bar Q/Q)}
\to \Isom(\pi_0(\Delta_1),\pi_0(\Delta_2))^{\Gal(\bar Q/Q)}$,
and if $f \in \Isom(\pi_0(\Delta_1),\pi_0(\Delta_2))^{\Gal(\bar Q/Q)}$,
then we write $\Isom_f((\Delta_1,\mu_1),(\Delta_2,\mu_2))^{\Gal(\bar Q/Q)}$
for the set of
$\phi \in \Isom((\Delta_1,\mu_1),(\Delta_2,\mu_2))^{\Gal(\bar Q/Q)}$
...
\begin{lemma} % {{{-2
 ...
 \[
  \#\Aut_\id(\Delta,\mu) =
  \begin{cases}
   1 &\text{if $(\Delta,\mu)$ has type $\DtA_1$,~$\DtB_n$, $\DtC_n$, $\DtD_n^\HQ$,
   or $\DtA_n$ and $\mu$ is not fixed by~$\tau$,}\\
...
$\phi \in \Isom_f((\Delta_1,\mu_1),(\Delta_2,\mu_2))^{\Gal(\QQbar/\QQ)}$.
...
\begin{proposition} % {{{-2
 ...
 $\psi_\ell \in
 \Isom_f((\Delta_1,\mu_1)_{\QQl},(\Delta_2,\mu_2)_{\QQl})^{\Gal(\QQlbar/\QQl)}$.
 Then there exists a
 $\phi \in \Isom_f((\Delta_1,\mu_1),(\Delta_2,\mu_2))^{\Gal(\QQbar/\QQ)}$
 ...
 \begin{proof}
  ...
  $\phi \in \Isom_f(\Delta_1,\Delta_2)^{\Gal(\QQbar/\QQ)}$.
  ...
  there is an element $\phi \in \Isom_f(\Delta_1,\Delta_2)^{\Gal(\QQbar/\QQ)}$,
  ...
  \begin{itemize}
   ...
   \item Now suppose that the type is $\DtA_n$ with $n \ge 2$,
  ...
  We save the case~$\DtD_4^\HQ$ for the \emph{coup de gr\^ace} of this proof.
  Suppose that the type is $\DtD_n^\HQ$ with $n \ge 5$,
  ...
  Finally, assume the type is $\DtD_4^\HQ$.
...
$\psi_\ell \in \Isom_f(\Delta_{1,\QQl},\Delta_{2,\QQl})^{\Gal(\QQlbar/\QQl)}$.
