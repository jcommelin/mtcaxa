...
\[
 ...
 \begin{tikzcd}
  & G_{1,\RR} \ar[d,two heads] \ar[r,hook]
  & \Aut(V)_{\RR} \\
...
\begin{enumerate*}[label=(\textit{\roman*})]
 \item \(G_{1}\) is a reductive algebraic group over~\(\QQ\)
  such that the projection \(G_{1} \onto G\) has central kernel;
 \item \(G_{1} \into \Aut(V)\) is a finite-dimensional faithful representation
  of~\(G_{1}\) on a vector space~\(V\) over~\(\QQ\);
...
% \[
%  (G,X) \longleftarrow (G_{1},X_{1})
%  \lhook\joinrel\longrightarrow (\CSp(V),\Sds),
% \]
% such that \(G\) is the adjoint group of~\(G_{1}\),
...
% In this section we propose a natural candidate for \((G_{1}, X_{1})\).
...
Take \(\mathcal{G}_{1} = \GL_{1}(Q)\) and \(V = Q \oplus \dual{Q}\).
Observe that \(V\) is naturally a faithful representation of
\(\Res_{E/\QQ} \mathcal{G}_{1}\).
Put \(G_{1} = (\Res_{E/\QQ} \mathcal{G}_{1}) \cdot \Gm \subset \Aut(V)\).

We claim that there is a unique
\(\tilde{h} \colon \DelS \to G_{1,\RR}\) that lifts~\(h\)
...
Put \(\mathcal{G}_{1} = \UU(B,\tau)\), and \(V = B\).
Observe that \(V\) is naturally a
faithful representation of \(\Res_{E/\QQ} \mathcal{G}_{1}\).
Put \(G_{1} = (\Res_{E/\QQ} \mathcal{G}_{1}) \cdot \Gm \subset \Aut(V)\).
...
Put \(\mathcal{G}_{1} = \Sp(A,\iota)\), and \(V = A\).
Observe that \(V\) is naturally a
faithful representation of \(\Res_{E/\QQ} \mathcal{G}_{1}\).
Put \(G_{1} = (\Res_{E/\QQ} \mathcal{G}_{1}) \cdot \Gm \subset \Aut(V)\).
...
Put \(\mathcal{G}_{1} = \Spin(A,\iota,f)\),
...
where \((A,\iota,f)\) is a central simple algebra over~\(E\)
of degree~\(2n\) with quadratic pair.
This time put \(\mathcal{G}_{1} = \OO^{+}(A,\iota,f)\), and \(V = A\).
Observe that \(V\) is naturally a
faithful representation of \(\Res_{E/\QQ} \mathcal{G}_{1}\).
Put \(G_{1} = (\Res_{E/\QQ} \mathcal{G}_{1}) \cdot \Gm \subset \Aut(V)\).
