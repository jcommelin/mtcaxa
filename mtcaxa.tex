...
and study a bit of their properties (\cref{ha-props}).
...
\begin{definition} % {{{-2
 ...
 and $\mu$ is a subset of special nodes of~$\Delta$
 that meets each connected component of~$\Delta$ in at most $1$~node.
...
Recall that $\Delta^{\mu}$ is symplectic (\cref{deldyn-symplectic}),
